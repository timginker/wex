...
To illustrate the weight decomposition, consider the estimate of the local level at time $t = 50$. Koopman and Harvey (2003) showed that the smoothed estimate can be written as
