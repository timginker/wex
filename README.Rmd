...
In this example, we use the \textbf{Nile} dataset to compute the smoothed and filtered values of the local level.
...
```
Now, let's consider the 50th value of the local level
